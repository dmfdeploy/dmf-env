...
Report privately via GitHub's **[Report a vulnerability](https://github.com/dmfdeploy/dmf-env/security/advisories/new)**
(Security → Advisories → Report a vulnerability) on the `dmf-env` repository.
