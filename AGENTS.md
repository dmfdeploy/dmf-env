...
Generic environment tooling for the DMF Platform — wizard, OpenTofu modules, `bin/` scripts; per-env state is operator-local (ADR-0035). See README.md and CLAUDE.md for repo specifics; cross-repo context —
